class Macbeth extends Phaser.Scene {
    ...
    create() {
        ...
        this.kirby = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'kirby').setOrigin(0, 1).setScale(0.1);
        this.mario = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'mario').setOrigin(0, 1).setScale(0.1);
        this.wright = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'wright').setOrigin(0, 1).setScale(0.5);
